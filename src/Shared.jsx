...
export const RUSSDENT_GRADIENT = 'linear-gradient(135deg, #d8a1e2 0%, #8d97da 100%)';
export const FF = "'Golos Text', system-ui, sans-serif";

export const RCard = ({ children, style, onClick }) => (
...
export const RGradCard = ({ children, style }) => (
  <div style={{
...
export const RBtn = ({ children, onClick, style, disabled }) => (
...
export const ROutlineBtn = ({ children, onClick, style }) => (
...
export const RSectionLabel = ({ children, style }) => (
  <p style={{
    fontSize: 11,
    fontWeight: 600,
...
export const RScreenHeader = ({ title, onBack, right }) => (
  <div style={{
    display: 'flex',
    alignItems: 'center',
    padding: '10px 20px',
...
export const RAvatar = ({ name, size = 44, style }) => {
